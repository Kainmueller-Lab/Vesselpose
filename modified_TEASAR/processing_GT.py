...
if __name__ == "__main__":
    swc_file_GT = '/mnt/md0/rajalakshmi/Unet_seg/VF/validation/validation_GT_graph/40/'
    roots_initial = [(312.482043688734, 201.272518511404, 4.0),
             ...
             (315.3108260009471, 128.4507495521172, 4.0),
    ...
    output_dir = "/mnt/md0/rajalakshmi/Unet_seg/VF/validation/validation_GT_graph/40_BP/"
    # Generate graphs

    G_GT = combine_swc_folder_to_graph(swc_file_GT)

    simplified_G = simplify_neuron_graph_corrected(G_GT, roots_initial)

    for root in roots_initial:
        if root not in simplified_G:
            simplified_G.add_node(root, **G_GT.nodes[root])
